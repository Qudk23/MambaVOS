...
def load_model(model, opt):
    ...
    if len(opt.gpu) > 1:
        ...
        del_list = ['mamba.vmunet.patch_embed.proj.weight', 'mamba.vmunet.patch_embed.proj.bias', 'mamba.vmunet.patch_embed.norm.weight', 'mamba.vmunet.patch_embed.norm.bias']
        for key in del_list:
